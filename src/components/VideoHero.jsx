...
const VideoHero = () => {
  return (
    <section className="w-full h-full relative overflow-hidden">
      <div className="bg-gradient-to-b from-[#00000044] to-[#c08f7cc7] w-full h-full absolute"></div>
      <video
        autoPlay
        muted
        loop
      ...
      {/* content */}
      <div className="p-2  gap-5 absolute flex flex-col justify-center items-center top-0 left-0 mt-24  w-full md:justify-start md:items-start md:p-8  lg:mt-40 md:gap-10">
        <h3 className=" font-roboto text-sm text-center font-bold uppercase md:text-lg lg:text-xl md:text-start">
